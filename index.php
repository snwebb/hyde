...
a {
    text-decoration: none; color: rgb(0,0,80);
}
...
if ($_GET['noplots']) {
  ...
  $other_exts = array('.pdf', '.cxx', '.eps', '.dia');
  foreach (glob("*") as $filename) {
    ...
    print "<a href=\"$filename\"><img src=\"$filename\" style=\"border: none; max-width:280px; max-height:330px; width:auto; height=auto; \"></a>";
    $others = array();
